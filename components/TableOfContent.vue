...
<template>
    <Transition
        ...
        <div v-if="storeToc.open" class="fixed top-0 right-0 mt-16 mr-3 w-80 max-[360px]:w-64 backdrop-blur-md bg-my-background/10 border border-white/10 rounded-xl p-5">
