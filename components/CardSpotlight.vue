<template>
    <div
        :class="[
      'group relative flex size-full overflow-hidden rounded-lg border border-white/15 bg-my-background/15 text-black',
      $props.class,
    ]"
        @mousemove="handleMouseMove"
        @mouseleave="handleMouseLeave"
    >
        <div :class="cn('z-10 size-full p-4 space-y-2', props.slotClass)">
            <slot></slot>
        </div>
        <div
