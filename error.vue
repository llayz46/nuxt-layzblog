...
useHead({
    title: `${props.error.statusCode} - ${props.error.statusMessage} | llayz`,
    meta: [
        {
            name: 'description',
        ...
        { property: 'og:title', content: `${props.error.statusCode} - ${props.error.statusMessage} | llayz` },
        { property: 'og:description', content: errorMessage },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: 'https://llayz.fr' + props.error.url },
        { property: 'og:image', content: 'https://llayz.fr/favicon.ico' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: `${props.error.statusCode} - ${props.error.statusMessage} | llayz` },
...
useSeoMeta({
    ...
    ogTitle: `${props.error.statusCode} - ${props.error.statusMessage} | llayz`,
    ogDescription: errorMessage,
    ogImage: 'https://llayz.fr/favicon.ico',
    ogUrl: 'https://llayz.fr' + props.error.url,
    twitterCard: 'summary_large_image',
    twitterTitle: `${props.error.statusCode} - ${props.error.statusMessage} | llayz`,
